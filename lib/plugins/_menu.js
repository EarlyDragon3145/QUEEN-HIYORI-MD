module.exports = {
  cmdName: () => ({
    name: ['menu'],
    alias: ['allmenu','commands','dashboard','h','help','00'],
    category: 'core',
    react: '📃',
...
*🍜 YᴏᴜTᴜʙᴇ :* https://YouTube.com/@ironmanhindigaming
*👥 Pᴜʙʟɪᴄ Gʀᴏᴜᴘ :* https://chat.whatsapp.com/Bq3X99koOopF4RAUkfA3Rz/
*📟 Repo :* https://github.com/ironmangaminga23/QUEEN-HIYORI-MD
